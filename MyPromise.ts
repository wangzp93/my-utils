...
class MyPromise {
     ...
     *         无回调，Promise穿透
     */
    private then(onResolved: Function, onRejected: Function): MyPromise {
     ...
     */
    static readonly resolve = function(value: any): MyPromise {
        // 传入Promise类型
     ...
     */
    static readonly reject = function(error: any): MyPromise {
     ...
     * 有一个失败就算失败，值为错误信息
     */
    static readonly all = function(promiseList: any[]): MyPromise {
     ...
     * 返回第一个执行结果，无论成功还是失败
     */
    static readonly race = function(promiseList: any[]): MyPromise {
        if (!(promiseList instanceof Array)) {
            return;
        }
        return new this((resolve: Function, reject: Function)=> {
     ...
     * 返回所有执行结果，无论成功还是失败
     */
    static readonly allSettled = function(promiseList: any[]): MyPromise {
        if (!(promiseList instanceof Array)) {
            return;
        }
        let rspList: any[] = [];
